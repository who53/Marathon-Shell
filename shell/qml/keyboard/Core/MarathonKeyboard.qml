...
Rectangle {
    ...
    Column {
        ...
        Item {
            ...
            implicitHeight: {
                if (qwertyLayout.visible)
                    return qwertyLayout.implicitHeight;
                if (symbolLayout.visible)
                    return symbolLayout.implicitHeight;
                if (emailLayout.visible)
                    return emailLayout.implicitHeight;
                if (urlLayout.visible)
                    return urlLayout.implicitHeight;
                if (numberLayout.visible)
                    return numberLayout.implicitHeight;
                if (numberLayout.visible)
                    return numberLayout.implicitHeight;
                if (phoneLayout.visible)
                    return phoneLayout.implicitHeight;
                if (emojiLayout.visible)
                    return emojiLayout.implicitHeight;
