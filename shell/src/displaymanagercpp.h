...
class DisplayManagerCpp : public QObject
{
    ...
    Q_PROPERTY(bool autoBrightnessEnabled READ autoBrightnessEnabled WRITE setAutoBrightness NOTIFY autoBrightnessEnabledChanged)
    Q_PROPERTY(bool rotationLocked READ rotationLocked WRITE setRotationLock NOTIFY rotationLockedChanged)
    ...
    Q_PROPERTY(int nightLightTemperature READ nightLightTemperature WRITE setNightLightTemperature NOTIFY nightLightTemperatureChanged)
...
public:
    explicit DisplayManagerCpp(PowerManagerCpp* powerManager, RotationManager* rotationManager, QObject* parent = nullptr);
    
    bool available() const { return m_available; }
    bool autoBrightnessEnabled() const { return m_autoBrightnessEnabled; }
    bool rotationLocked() const { return m_rotationLocked; }
    ...
    QString nightLightSchedule() const { return m_nightLightSchedule; }
